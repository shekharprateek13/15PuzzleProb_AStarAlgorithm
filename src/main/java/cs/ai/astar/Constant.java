...
/**
 * This class defines the Constants which are to be used in A* Search Algorithm Implementation
...
public class Constant {
	...
	/**
	 * The possible values of heuristic function
	 */
	public static enum HEURISTIC_FUNCTION  {
		MISPLACED_TILES,
		MANHATTAN_DISTANCE;
	};
